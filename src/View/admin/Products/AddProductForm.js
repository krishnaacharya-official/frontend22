            ...
            >
                ...
                <Modal.Body>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="text" className="form-control form-control-plaintext" name='title' id="title" value={stateData.title} onChange={(e) => { props.changevalue(e) }} />

                            {stateData.error && stateData.error.title && <p className="error">{stateData.error ? stateData.error.title ? stateData.error.title : "" : ""}</p>}
                        </div>
                    </div>
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            ...
                            {stateData.error && stateData.error.subtitle && <p className="error">{stateData.error ? stateData.error.subtitle ? stateData.error.subtitle : "" : ""}</p>}
                        </div>
                    </div>
