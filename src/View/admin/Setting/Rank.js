            ...
            <form className="mb-4 p-4">
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.captian && (
                    <p className="error">{error ? (error.captian ? error.captian : '') : ''}</p>
                  )}
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.admiral && (
                    <p className="error">{error ? (error.admiral ? error.admiral : '') : ''}</p>
                  )}
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.pirate && (
                    <p className="error">{error ? (error.pirate ? error.pirate : '') : ''}</p>
                  )}
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.narwhal && (
                    <p className="error">{error ? (error.narwhal ? error.narwhal : '') : ''}</p>
                  )}
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.beluga && (
                    <p className="error">{error ? (error.beluga ? error.beluga : '') : ''}</p>
                  )}
                </div>
              </div>
              <div className="form-group row">
                ...
                <div className="col-sm-10">
                  ...
                  {error && error.fish && (
                    <p className="error">{error ? (error.fish ? error.fish : '') : ''}</p>
                  )}
                </div>
              </div>
