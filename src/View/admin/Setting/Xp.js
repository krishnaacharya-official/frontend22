            ...
            <form className="mb-4 p-4">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  <div className="input-group">
                    ...
                    />
                    <span className="input-group-addon11">XP</span>
                  </div>
                  {error && error.topDonator && (
                    <p className="error">
                      {error ? (error.topDonator ? error.topDonator : '') : ''}
                    </p>
                  )}
                </div>
              </div>

              <label htmlFor="topDonation">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.topDonation && (
                    <p className="error">
                      {error ? (error.topDonation ? error.topDonation : '') : ''}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.forEachItem && (
                    <p className="error">
                      {error ? (error.forEachItem ? error.forEachItem : '') : ''}
                    </p>
                  )}
                </div>
              </div>

              <label htmlFor="forEachDonation">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.forEachDonation && (
                    <p className="error">
                      {error ? (error.forEachDonation ? error.forEachDonation : '') : ''}
                    </p>
                  )}
                </div>
              </div>

              <label htmlFor="forEachShare">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.forEachShare && (
                    <p className="error">
                      {error ? (error.forEachShare ? error.forEachShare : '') : ''}
                    </p>
                  )}
                </div>
              </div>

              <label htmlFor="forEachOrganization">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.forEachOrganization && (
                    <p className="error">
                      {error ? (error.forEachOrganization ? error.forEachOrganization : '') : ''}
                    </p>
                  )}
                </div>
              </div>
