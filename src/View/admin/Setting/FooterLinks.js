            ...
            <form className="mb-4 p-4">
              <div className="form-group row">
                ...
                <div className="col-sm-11">
                  ...
                  {error && error.twitter && (
                    <p className="error">{error ? (error.twitter ? error.twitter : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-11">
                  ...
                  {error && error.facebook && (
                    <p className="error">{error ? (error.facebook ? error.facebook : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-11">
                  ...
                  {error && error.instagram && (
                    <p className="error">{error ? (error.instagram ? error.instagram : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-11">
                  ...
                  {error && error.discord && (
                    <p className="error">{error ? (error.discord ? error.discord : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                ...
                <div className="col-sm-11">
                  ...
                  {error && error.footerEmail && (
                    <p className="error">
                      {error ? (error.footerEmail ? error.footerEmail : '') : ''}
                    </p>
                  )}
                </div>
              </div>

              <Button variant="contained" className="settingButton" onClick={(e) => saveSettings()}>
                Save
              </Button>
            </form>
          </Card>
