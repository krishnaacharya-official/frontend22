            ...
            <form className="mb-4 p-4">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.awsSecretAccessKey && (
                    <p className="error">
                      {error ? (error.awsSecretAccessKey ? error.awsSecretAccessKey : '') : ''}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.awsAccessKeyId && (
                    <p className="error">
                      {error ? (error.awsAccessKeyId ? error.awsAccessKeyId : '') : ''}
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.bucketName && (
                    <p className="error">
                      {error ? (error.bucketName ? error.bucketName : '') : ''}
                    </p>
                  )}
                </div>
              </div>
