            ...
            <form className="mb-4 p-4">
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.host && (
                    <p className="error">{error ? (error.host ? error.host : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  ...
                  {error && error.port && (
                    <p className="error">{error ? (error.port ? error.port : '') : ''}</p>
                  )}
                </div>
              </div>
              ...
              <div className="form-group row">
                <div className="col-sm-12">
                  <select
                    ...
                    name="secure"
                  >
                    <option selected={secure === 'true'} value={true}>
                      TRUE
                    </option>
                    <option selected={secure === 'false'} value={false}>
                      FALSE
                    </option>
                  </select>
                </div>
