      ...
      <Nav variant="link" {...otherProps} onClick={_onClick}>
        ...
        <Link to={'/user/' +newSlug + '/settings/profile'}>
          <Nav.Item>
            <Nav.Link
              eventKey="profile"
              className={currentOption === 'profile' ? "stab__btn d-flex align-items-center active" : "stab__btn d-flex align-items-center"}
            // className={}
            >
        ...
        <Link to={'/user/' +newSlug + '/settings/accounts'}>
          <Nav.Item >
            <Nav.Link
              eventKey="accounts"
              className={currentOption === 'accounts' ? "stab__btn d-flex align-items-center active" : "stab__btn d-flex align-items-center"}
            >
              <span className="stab__icon">
        ...
        <Link to={'/user/' +newSlug + '/settings/billing'}>
          <Nav.Item onClick={_onClick}>
            <Nav.Link
              eventKey="billing"
              className={currentOption === 'billing' ? "stab__btn d-flex align-items-center active" : "stab__btn d-flex align-items-center"}
            >
              <span className="stab__icon">
        ...
        {/* <Link to={'/user/' +newSlug + '/settings/administrator'}>
          <Nav.Item>
            <Nav.Link
              ...
              className={currentOption === 'administrator' ? "stab__btn d-flex align-items-center active" : "stab__btn d-flex align-items-center"}
            >
              <span className="stab__icon">
