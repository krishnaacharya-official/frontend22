  ...
  return (
    <div className="summary__content">
                  ...
                  <div className="d-flex align-items-center mb-2 mb-sm-0 flex__1">
                    <div className="position-relative">
                      <ListItemImg
                        ...
                        className="border"
                      />
                      <span className="badge item__img-badge fw-bold fs-8">
                        {item.quantity}
                      </span>
                    </div>
      ...
      <div className="note note--info px-0 text-center">
        Donorport is completely free for donors &amp;&nbsp;charities,
        meaning the organization(s) receive 100% of the checkout total.{" "}
