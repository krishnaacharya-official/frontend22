...
// import RetMapboxGl, { Feature, Layer, Marker, ScaleControl } from 'react-mapbox-gl';
...
// // const ReactMapboxGl = typeof window === 'object' ? require('react-mapbox-gl').default : () => false;

// // const { Layer, Feature, Marker, ScaleControl } = ReactMapboxGl;
