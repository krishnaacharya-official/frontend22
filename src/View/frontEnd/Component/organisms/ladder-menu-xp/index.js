  ...
  return (
    <div className="ladder__menu position-relative">
      ...
      >
        ...
        <li className="ladder__menu-item" onClick={() => {
          setActive(false)
          props.onChangeDropdown('DONATED', 'https://uploads-ssl.webflow.com/59de7f3f07bb6700016482bc/60088347cb80b5186f9e1ead_donate.svg')
        }}>
          <div className="ladder__icon">
            <img
              alt=""
        ...
        <li className="ladder__menu-item " onClick={() => {
          setActive(false)
          props.onChangeDropdown('FOLLOWED', 'https://uploads-ssl.webflow.com/59de7f3f07bb6700016482bc/5ef6176ab4ea47d76444346c_speech-bubble.svg')
        }}>
          <div className="ladder__icon">
            <img
              alt=""
        ...
        <li
          ...
          onClick={() => {
            setActive(false)
            props.onChangeDropdown('SHARED', 'https://uploads-ssl.webflow.com/59de7f3f07bb6700016482bc/5ef61ef15babc48a50bd2bd5_share.svg')
          }}
        >
          <div className="ladder__icon">
            <img
        ...
        <li className="ladder__menu-item" onClick={() => {
          setActive(false)
          props.onChangeDropdown('BOUGHT', 'https://uploads-ssl.webflow.com/59de7f3f07bb6700016482bc/5e4c2ff23144db148fd45b43_wallet.svg')
        }}>
          <div className="ladder__icon">
            <img
              alt=""
