...
const AdminControl = () => {
  ...
  const {
    ...
    email,
    items_are_funded,
    you_receive_donation,
    someone_follows_profile,
    sales_on_your_post,
    your_item_funded,
    your_order_ready_to_purchase,
    problem_with_your_deposit,
  ...
  return (
    <>
        ...
        <div>
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="items_are_funded"
                checked={items_are_funded}
                name="items_are_funded"
                changevalue={changevalue}
              />
            </span>
          ...
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="you_receive_donation"
                checked={you_receive_donation}
                name="you_receive_donation"
                changevalue={changevalue}
              />
            </span>
          ...
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="someone_follows_profile"
                checked={someone_follows_profile}
                name="someone_follows_profile"
                changevalue={changevalue}
              />
            </span>
            <span className="text-subtext fs-7">Someone follows your profile</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="text-subtext mb-3">Notify you when there is activity on items you post</div>
        <div>
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="sales_on_your_post"
                checked={sales_on_your_post}
                name="sales_on_your_post"
                changevalue={changevalue}
              />
            </span>
          ...
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="your_item_funded"
                checked={your_item_funded}
                name="your_item_funded"
                changevalue={changevalue}
              />
            </span>
          ...
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="your_order_ready_to_purchase"
                checked={your_order_ready_to_purchase}
                name="your_order_ready_to_purchase"
                changevalue={changevalue}
              />
            </span>
            <span className="text-subtext fs-7">Your order is ready for purchase</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="text-subtext mb-3">
          Notify you when there are issues with your payments / saved cards
        </div>
        <div>
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="problem_with_your_deposit"
                checked={problem_with_your_deposit}
                name="problem_with_your_deposit"
                changevalue={changevalue}
              />
            </span>
      ...
      <div className="mb-5">
        ...
        <div>
          <div className="d-flex align-items-center mb-2">
            <span className="d-flex pe-2 py-1">
              <ToggleSwitch
                id="keep_profile_private"
                checked={keep_profile_private}
                name="keep_profile_private"
                changevalue={changevalue}
              />
            </span>
