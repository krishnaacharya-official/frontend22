...
const Terms = () => {
  return (
    <DefaultLayout>
      ...
      <h1 className="text-dark fw-bolder mb-6p pt-2">Terms & Conditions
</h1>
        <div className="terms">
          <div className="mw-900">
            <div className="text-subtext_light lh-1.5">
              <strong className="text-dark mb-1">OVERVIEW</strong>
              <br />
              This website is operated by Donorport Ltd. Throughout the site,
              the terms “we”, “us” and “our” refer to Donorport. Donorport
              ...
              <br />
              <br />
              <strong className="text-dark mb-1">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</strong>
              <br />
              ...
              <br />
              <br />
              <strong className="text-dark mb-1">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</strong>
              <br />
              ...
              non-infringement.
              <br />
              In no case shall bonjohns, our directors, officers, employees,
              ...
              <br />
              You agree to indemnify, defend and hold harmless bonjohns and our
